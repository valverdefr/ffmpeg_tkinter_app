...
def update_custom_progress_bar(file_name):
    ...
    # Draw a big blue bar
    custom_canvas.create_rectangle(10, 10, 390, 50, fill="blue", outline="blue")
    
    # Add video name as caption inside the bar
    custom_canvas.create_text(200, 30, text=file_name.split('/')[-1], fill="white", font=('Arial', 12, 'bold'))
...
# Big blue custom progress bar canvas
custom_canvas = tk.Canvas(root, width=400, height=60)
